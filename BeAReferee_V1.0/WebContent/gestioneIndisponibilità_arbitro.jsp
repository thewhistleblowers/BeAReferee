...
<html>
	...
	<body class="news">
		...
		<main>
			...
			<br>
			<br>
			<form method="post" action="controlloIndisponibilita.jsp">
			<table>
        		<thead>
          			<tr>
        		...
        		<tbody>
          			<tr>
            			...
            			<td>
            				<input name="dataIni" type="date" class="datepicker" min="<%=result %>" required>
            			</td>
            			<td>
            				<input name="dataFin" type="date" class="datepicker" min="dataIni" required>
            			</td>	
          			</tr>
        		</tbody>
      		</table>
      		...
      		<br>
  			 ...
  			 <button class="btn waves-effect waves-light green" type="submit" name="action">Richiedi
