...
<%
    if ((session.getAttribute("presidente") == null) || (session.getAttribute("userid") == ""))  
	...
	<% Cookie[] cookies = request.getCookies();
		...
		<header>
    		...
    		<ul id="slide-out" class="side-nav fixed">
    			<li class="logo">
    				<a id="logo-container" href="HomePagePersonale_presidente.jsp">
            		<object id="front-page-logo" data="img/presidente_icon.png"></object></a>
            	</li>
            	<br>
            	<br>
      			<li><a href="#!" class="blue-grey">Area Personale</a></li>
      			<li class="no-padding">
		...
		<form method="post" action="controlloModifica.jsp">
		<main>
		...
		<div class="row">
        	...
        	<div class="input-field col s6">
          			<input value="<%=user.getIndirizzo()%>" name="indirizzo" id="indirizzo_di_residenza" type="text" class="validate">
          			<label for="indirizzo_di_residenza">Indirizzo di Residenza</label>
        		</div>
        	<div class="input-field col s6">
          			<input value="<%=user.getCittà()%> "name="citta" id="città_di_residenza" type="text" class="validate">
          			<label for="città_di_residenza">Città di Residenza</label>
        		</div>
        		<div class="input-field col s6">
          			<input value="<%=user.getCivico()%> "name="civico" id="numero_civico" type="text" class="validate">
          			<label for="città_di_residenza">Numero Civico</label>
        		</div>
        		<div class="input-field col s6">
          			<input value="<%=user.getRegioneResid()%> "name="regione" id="regione_di_residenza" type="text" class="validate">
          			<label for="città_di_residenza">Regione di Residenza</label>
        		</div>
        	<div class="input-field col s6">
          			<input value="<%=user.getTelefono()%>" name="telefono" id="recapito_telefonico" type="text" class="validate">
          			<label for="recapito_telefonico">Recapito Telefonico</label>
        		</div>				
        	<div class="input-field col s6">
          			<input value="<%=user.getE_mail()%>" name="email" id="indirizzo_e-mail" type="text" class="validate">
        ...
        <button class="btn waves-effect waves-light green" type="submit" name="action" onClick="window.location.reload()">Applica Modifiche
